...
class DealsSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        yield scrapy.Request(url="https://www.geekbuying.com/deals", callback=self.parse, headers={'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.130 Safari/537.36'})
